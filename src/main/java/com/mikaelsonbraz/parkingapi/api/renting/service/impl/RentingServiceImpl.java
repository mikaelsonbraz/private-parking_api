...
public class RentingServiceImpl implements RentingService {
    ...
    public Renting save(Renting renting) {
        ...
        parkingSpaceService.setRentingOnParkingSpace(renting.getParkingSpace(), renting);
    ...
    public Renting update(Renting renting) {
        ...
        parkingSpaceService.setRentingOnParkingSpace(renting.getParkingSpace(), null);
        renting.getParkingSpace().setOccupied(false);
        return this.repository.save(renting);
    }
